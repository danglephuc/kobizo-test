...
export const PostTable = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (row)=>{
                return <div>
                    <Button className='btn-icon' type='warning' size='small' icon="edit" onClick={editPost.bind(this, row)} />
                </div>
            }
        }
    ];
    ...
    return (
        <Loading loading={loading}>
            ...
            <Pagination
                ...
                onSizeChange={(value) => { onPageSizeChanged(value) }}
                onCurrentChange={(value) => { onPageChanged(value) }}
            />
        </Loading>
    )
}
